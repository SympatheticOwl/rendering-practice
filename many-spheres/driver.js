...
function updateBuffers() {
    ...
    const centers = new Float32Array(SPHERES.flatMap(s => s.position));
    ...
    const colors = new Float32Array(SPHERES.flatMap(s => [s.r, s.g, s.b, s.a]));
...
function draw(seconds) {
    ...
    gl.uniform1f(program.uniforms.viewport_size, gl.canvas.width);
